...
![MinGW安装](D:\Repository\fdu-20ss-programming-A\lab0\.assets\image-20200911155030937.png)

安装路径默认在C盘，我们也可以自定义安装位置。

![MinGW安装路径](D:\Repository\fdu-20ss-programming-A\lab0\.assets\image-20200911155322362.png)

> 注意：安装的位置将会在后面使用到，所以请务必记住安装的路径。

MinGW安装结束后，我们将会看到MinGW的包管理页面。

![包管理页面](D:/Repository/fdu-20ss-programming-A/lab0/images/image-20200911160035400-1599897557043.png)
...
![image-20200911161749691](D:\Repository\fdu-20ss-programming-A\lab0\.assets\image-20200911161749691.png)
...
![环境变量](D:\Repository\fdu-20ss-programming-A\lab0\.assets\image-20200911163338217.png)

在`系统变量`中寻找`Path`，点击编辑。

![编辑环境变量](D:\Repository\fdu-20ss-programming-A\lab0\.assets\image-20200911163639336.png)
...
![运行cmd](D:\Repository\fdu-20ss-programming-A\lab0\.assets\image-20200911170115234.png)

完成后，将打开命令行终端。

![终端](D:\Repository\fdu-20ss-programming-A\lab0\.assets\image-20200911170338385.png)

##### 测试GCC与GDB

在终端中输入`gcc -v`查看GCC的版本信息，输入`gdb -v`查看gdb版本。

![gcc与gdb版本](D:\Repository\fdu-20ss-programming-A\lab0\.assets\image-20200911170438031.png)
...
![cb安装位置](D:\Repository\fdu-20ss-programming-A\lab0\.assets\image-20200911191048132.png)
...
![cb安装完成](D:\Repository\fdu-20ss-programming-A\lab0\.assets\image-20200911191548378.png)

打开 `Settings`->`Compiler`->`Global compiler settings`->`Toolchain executables`。修改`Compiler's installation directory` 为MinGW/bin的路径。

![GCC路径](D:\Repository\fdu-20ss-programming-A\lab0\.assets\image-20200911192120165.png)

打开`Settings` -> `Default`，修改`executable path`为MinGW/bin/gdb.exe的路径。

![配置GDB](D:\Repository\fdu-20ss-programming-A\lab0\.assets\image-20200911192534940.png)
...
![打开终端](D:\Repository\fdu-20ss-programming-A\lab0\.assets\image-20200911222300273.png)
...
![终端测试gcc](D:\Repository\fdu-20ss-programming-A\lab0\.assets\image-20200911222542096.png)
